...
from SWAGGYMUSIC.misc import HAPP, SUDOERS, XCB
from SWAGGYMUSIC.utils.database import (get_active_chats, remove_active_chat,
...
async def update_(client, message, _):
    ...
    if await is_heroku():
        ...
        os.system(f"kill -9 {os.getpid()} && python3 -m SWAGGYMUSIC")


# ---------------- RESTART ----------------
@app.on_message(filters.command(["restart"]) & SUDOERS)
async def restart_(_, message):
    response = await message.reply_text("ʀєsᴛʌʀᴛɪɴɢ...")
