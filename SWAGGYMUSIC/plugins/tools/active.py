...
from SWAGGYMUSIC.utils.database import (get_active_chats,
...
async def activevc(_, message: Message):
    mystic = await message.reply_text("» ɢєᴛᴛɪɴɢ ʌᴄᴛɪᴠє ᴠᴏɪᴄє ᴄʜʌᴛs ʟɪsᴛ...")
...
async def activevi_(_, message: Message):
    mystic = await message.reply_text("» ɢєᴛᴛɪɴɢ ʌᴄᴛɪᴠє ᴠɪᴅєᴏ ᴄʜʌᴛs ʟɪsᴛ...")
