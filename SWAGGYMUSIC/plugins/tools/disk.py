...
#
# This file is part of < https://github.com/yuki77394/TheSWAGGYMUSIC > project,
# and is released under the "GNU v3.0 License Agreement".
# Please see < https://github.com/yuki77394/TheSWAGGYMUSIC/blob/master/LICENSE >
#
# All rights reserved.
...
async def handle_clean_callback(_, query):
    ...
    if action == "all":
        ...
        await query.answer("ᴄʟєʌɴєᴅ ʌʟʟ ꜰᴏʟᴅєʀs")
        await query.message.edit_text("\n".join(results))
        return

    success, message = await clean_folder(action)
    await query.answer("⌯ ✅ ᴅᴏɴє ⌯" if success else "⌯ ❌ єʀʀᴏʀ ⌯")
