...
from SWAGGYMUSIC.utils.database import (get_assistant, get_cmode, get_lang,
                                       get_playmode, get_playtype,
                                       is_active_chat, is_maintenance)
from SWAGGYMUSIC.utils.inline import botplaylist_markup
...
def PlayWrapper(command):
    async def wrapper(client, message):
        ...
        # Deletion removed to support editing of the initial 'Searching' message.
        # Initial message will be sent in play_commnd and edited thereafter.
