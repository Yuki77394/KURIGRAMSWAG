...
- Migrated the Telegram MTProto client dependency from PyroBlack to Kurigram 2.2.25 while preserving the existing `pyrogram` import namespace and plugin flow.
- Updated PyTgCalls to 2.3.3 with stable ntgcalls 2.2.5.
- Standardized deployment/runtime metadata on Python 3.11.
...
## [1.0.0] – YYYY-MM-DD  
### Added  
- Initial release of the project based on SWAGGYMUSIC.  
